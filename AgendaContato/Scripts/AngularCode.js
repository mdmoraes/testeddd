    ...
    $scope.InsertData = function () {
        ...
        if(Action == "Submit") {  
            $scope.Employe = {};
                        ...
                        $http({
                                method: "post",  
                                url: "http://localhost:57450/Employee/Insert_Employee",  
                                datatype: "json",  
                        ...
                        $http({
                            method: "post",  
                            url: "http://localhost:57450/Employee/Update_Employee",  
                            datatype: "json",  
                            data: JSON.stringify($scope.Employe)  
            }).then(function (response) {
                                    alert(response.data);
        ...
        $scope.GetAllData = function () {
                $http({
                        method: "get",  
                        url: "http://localhost:57450/Employee/Get_AllEmployee"  
        }).then(function (response) {
        ...
        $scope.DeleteEmp = function (Emp) {
                $http({
                        method: "post",  
                        url: "http://localhost:57450/Employee/Delete_Employee",  
                        datatype: "json",  
